    ...
    return (
        <Layout>
            <div className={styles.container}>
                ...
                <div className={styles.centercontent}>
                    ...
                    <div className={styles.contentdata}>
                        <span className={styles.blogcategory}> <i class='blue bx bxs-circle'></i> Gaming</span>
                        <span><i class='bx bx-calendar-event'></i> Oct 1, 2021</span>
                    </div>
                    <picture>
            ...
            <div className="newsletter">
                <h2><i class='bx bx-paper-plane'></i> Suscribete</h2>
